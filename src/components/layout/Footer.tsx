...
import { Lightning, TwitterLogo, LinkedinLogo, GithubLogo, EnvelopeSimple } from '@phosphor-icons/react'
          ...
          <div className="col-span-2">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">
                Build faster, ship smarter. The complete platform for modern development teams.
              </p>
            </motion.div>
